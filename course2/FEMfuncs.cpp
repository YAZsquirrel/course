...
real FEM::f(knot point, real t)
{
	...
	case 4: return 0;
	case 5: return point.x * point.x * point.x * point.x + point.y * point.y + point.x * point.y + 1 - 12 * point.x * point.x - 2;
...
real FEM::ug(knot point, real t)
{
	...
	case 3: return point.y;
	case 4: return 0;
	case 5: return point.x * point.x * point.x * point.x + point.y * point.y  + point.x * point.y + 1;
